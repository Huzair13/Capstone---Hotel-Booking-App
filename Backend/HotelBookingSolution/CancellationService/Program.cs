...
using CancellationService.Repositories;
using CancellationService.Services;
...
namespace CancellationService
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Configure DbContext
            builder.Services.AddDbContext<CancelServiceContext>(options =>
            ...
            builder.Services.AddScoped<IRepository<int, Cancel>, CancelRepository>();
            builder.Services.AddScoped<IRepository<int,Refund>, RefundRepository>();
            builder.Services.AddScoped<ICancelService, CancelServices>();
